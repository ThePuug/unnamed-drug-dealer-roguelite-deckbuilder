...
- **Specs:** Named by system (e.g., `card-system.md`)
- **RFCs:** Numbered sequentially (e.g., `001-dealer-mechanics.md`)
- **ADRs:** Numbered independently (e.g., `001-deck-builder-architecture.md`)
- **SOWs:** Match RFC numbers (e.g., RFC-001 → SOW-001)
...
- **"Continue RFC-001"** → All context in `01-rfc/001-dealer-mechanics.md`
- **"Continue SOW-001"** → All context in `03-sow/001-dealer-mechanics.md`
