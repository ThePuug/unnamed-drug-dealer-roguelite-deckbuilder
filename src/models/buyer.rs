...
pub struct BuyerScenario {
    pub id: String,                          // "get_wild", "rock_bottom"
    ...
    pub special_rules: Vec<SpecialRule>,     // Future: Modifiers for this scenario
}

/// Buyer persona - merges Dealer scenario deck + Customer modifiers into one entity
#[derive(Debug, Clone)]
pub struct BuyerPersona {
    pub id: String,                          // "frat_bro", "desperate_housewife"
    ...
    pub special_rules: Vec<SpecialRule>,     // Conditional effects
