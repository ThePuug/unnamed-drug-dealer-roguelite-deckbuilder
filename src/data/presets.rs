...
pub fn create_default_deck() -> Vec<Card> {
    vec![
        ...
        Card { id: 12, name: "Codeine".to_string(),            card_type: CardType::Product { price: 50, heat: 10 } },
        Card { id: 14, name: "Ecstasy".to_string(),            card_type: CardType::Product { price: 80, heat: 25 } },
        Card { id: 16, name: "Coke".to_string(),            card_type: CardType::Product { price: 120, heat: 35 } },
        Card { id: 18, name: "Fentanyl".to_string(),            card_type: CardType::Product { price: 200, heat: 50 } },
        // 4 locations (all of them - dealer safe)
        Card { id: 19, name: "Safe House".to_string(),            card_type: CardType::Location { evidence: 10, cover: 30, heat: -5 } },
        Card { id: 20, name: "Abandoned Warehouse".to_string(),            card_type: CardType::Location { evidence: 15, cover: 25, heat: -10 } },
        Card { id: 21, name: "Storage Unit".to_string(),            card_type: CardType::Location { evidence: 12, cover: 28, heat: -8 } },
        Card { id: 22, name: "Dead Drop".to_string(),            card_type: CardType::Location { evidence: 8, cover: 20, heat: -5 } },
        // 4 Cover cards (all of them)
        Card { id: 23, name: "Alibi".to_string(),            card_type: CardType::Cover { cover: 30, heat: -5 } },
        Card { id: 24, name: "Bribe".to_string(),            card_type: CardType::Cover { cover: 25, heat: 10 } },
        Card { id: 25, name: "Fake Receipts".to_string(),            card_type: CardType::Cover { cover: 20, heat: 5 } },
        Card { id: 26, name: "Bribed Witness".to_string(),            card_type: CardType::Cover { cover: 15, heat: -10 } },
        // 2 Insurance (all of them)
        Card { id: 27, name: "Plea Bargain".to_string(),            card_type: CardType::Insurance { cover: 20, cost: 1000, heat_penalty: 20 } },
        Card { id: 28, name: "Fake ID".to_string(),            card_type: CardType::Insurance { cover: 15, cost: 0, heat_penalty: 40 } },
        // 5 modifiers (all of them)
        Card { id: 29, name: "Disguise".to_string(),            card_type: CardType::DealModifier { price_multiplier: 1.0, evidence: 0, cover: 20, heat: -5 } },
        Card { id: 30, name: "Burner Phone".to_string(),            card_type: CardType::DealModifier { price_multiplier: 1.0, evidence: 0, cover: 15, heat: -10 } },
        Card { id: 31, name: "Lookout".to_string(),            card_type: CardType::DealModifier { price_multiplier: 1.0, evidence: 0, cover: 20, heat: 0 } },
        Card { id: 32, name: "Clean Money".to_string(),            card_type: CardType::DealModifier { price_multiplier: 0.9, evidence: 0, cover: 10, heat: -15 } },
        Card { id: 33, name: "False Trail".to_string(),            card_type: CardType::DealModifier { price_multiplier: 1.0, evidence: -10, cover: 15, heat: -5 } },
    ]
}
...
pub fn create_aggro_deck() -> Vec<Card> {
    vec![
        ...
        // Risky locations (2)
        Card { id: 16, name: "School Zone".to_string(),            card_type: CardType::Location { evidence: 40, cover: 5, heat: 20 } },
        Card { id: 18, name: "Back Alley".to_string(),            card_type: CardType::Location { evidence: 25, cover: 20, heat: 0 } },
...
pub fn create_control_deck() -> Vec<Card> {
    vec![
        ...
        Card { id: 17, name: "Warehouse".to_string(),            card_type: CardType::Location { evidence: 15, cover: 25, heat: -10 } },
        Card { id: 18, name: "Back Alley".to_string(),            card_type: CardType::Location { evidence: 25, cover: 20, heat: 0 } },
        // All Cover cards (4)
        Card { id: 19, name: "Alibi".to_string(),            card_type: CardType::Cover { cover: 30, heat: -5 } },
        ...
        Card { id: 27, name: "Lookout".to_string(),            card_type: CardType::DealModifier { price_multiplier: 1.0, evidence: 0, cover: 20, heat: 0 } },
        Card { id: 28, name: "Clean Money".to_string(),            card_type: CardType::DealModifier { price_multiplier: 0.9, evidence: 0, cover: 10, heat: -15 } },
